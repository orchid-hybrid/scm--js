...
write_to_string((js_dash_string_dash__gt_symbol("x"))
)+"<br/>");

document.write("(car (cdr (quote (my other car))))"+": "+
write_to_string(((car)((cdr)(cons(js_dash_string_dash__gt_symbol("my"), cons(js_dash_string_dash__gt_symbol("other"), cons(js_dash_string_dash__gt_symbol("car"), null))))))
)+"<br/>");

document.write("(car (cdr (list (quote my) (quote other) (quote car))))"+": "+
write_to_string(((car)((cdr)((list)(js_dash_string_dash__gt_symbol("my"), js_dash_string_dash__gt_symbol("other"), js_dash_string_dash__gt_symbol("car")))))
)+"<br/>");

document.write("(car (cdr ((lambda (o) (quasiquote (my (unquote o) car))) (quote other))))"+": "+
write_to_string(((car)((cdr)((function(o){return cons(js_dash_string_dash__gt_symbol("my"), cons(o, cons(js_dash_string_dash__gt_symbol("car"), null)))})(js_dash_string_dash__gt_symbol("other")))))
)+"<br/>");

document.write("((lambda (x) (cond ((null? x) (quote null)) ((pair? x) (quote pair)) (else (quote other)))) (quote (1 . 2)))"+": "+
write_to_string(((function(x){return (runtime_dash_booleanize((null_huh_)(x)))?((function(){return js_dash_string_dash__gt_symbol("null")})()):((runtime_dash_booleanize((pair_huh_)(x)))?((function(){return js_dash_string_dash__gt_symbol("pair")})()):((function(){return js_dash_string_dash__gt_symbol("other")})()))})(cons(1, 2)))
)+"<br/>");
...
write_to_string(((car)((cdr)((list)((list_huh_)(js_dash_string_dash__gt_symbol("a")), (list_huh_)(cons(js_dash_string_dash__gt_symbol("a"), cons(js_dash_string_dash__gt_symbol("b"), null))), (list_huh_)(null)))))
)+"<br/>");
...
write_to_string(((if_dash_expression_huh_)(cons(js_dash_string_dash__gt_symbol("if"), cons(js_dash_string_dash__gt_symbol("a"), cons(js_dash_string_dash__gt_symbol("b"), cons(js_dash_string_dash__gt_symbol("c"), null))))))
)+"<br/>");

document.write("(if-expression? (quote (uf a b c)))"+": "+
write_to_string(((if_dash_expression_huh_)(cons(js_dash_string_dash__gt_symbol("uf"), cons(js_dash_string_dash__gt_symbol("a"), cons(js_dash_string_dash__gt_symbol("b"), cons(js_dash_string_dash__gt_symbol("c"), null))))))
)+"<br/>");

document.write("(if-expression? (quote (uf b c)))"+": "+
write_to_string(((if_dash_expression_huh_)(cons(js_dash_string_dash__gt_symbol("uf"), cons(js_dash_string_dash__gt_symbol("b"), cons(js_dash_string_dash__gt_symbol("c"), null)))))
)+"<br/>");

document.write("(runtime-primitive? (quote string->symbol))"+": "+
write_to_string(((runtime_dash_primitive_huh_)(js_dash_string_dash__gt_symbol("string->symbol")))
)+"<br/>");
...
write_to_string(((mangle_dash_name)(js_dash_string_dash__gt_symbol("?aa")))
)+"<br/>");
